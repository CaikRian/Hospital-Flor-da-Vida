...
<body>
    ...
    <div class="container mt-5 pt-5" id="custom_container">
        ...
        <form action="" method="POST">
            <div class="row mb-3">
                <label for="data_consulta" class="col-sm-2 col-form-label">Data da Consulta</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                <label for="horario_consulta" class="col-sm-2 col-form-label">Horário da Consulta</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                <label for="motivo_consulta" class="col-sm-2 col-form-label">Motivo da Consulta</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                <label for="id_medico" class="col-sm-2 col-form-label">Médico</label>
                <div class="col-sm-10">
